...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/timestreamquery v1.25.7 // indirect
	github.com/aws/aws-sdk-go-v2/service/timestreamwrite v1.27.6 // indirect
